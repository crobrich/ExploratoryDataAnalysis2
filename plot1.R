...
## Plot in base system
plot(xem,yem, type="b", col= "red", xaxt="n", xlab="Year", ylab="Total PM2.5 Emissions (millions of tons)")
title(main="Total PM2.5 Emissions in the USA in Selected Years")
axis(1,at=xem)
