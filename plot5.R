## PM2.5 Emissions from motor vehicles in Baltimore City, Md
...
## Plot in base system
plot(xem,yem, type="b", col= "red", xaxt="n", xlab="Year", ylab="Motor Vehicle PM2.5 Emissions (tons)")
title(main="Motor Vehicle PM2.5 Emissions, Baltimore City, Selected Years")
axis(1,at=xem)
